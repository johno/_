...
_[New Blogging 1 - Building Blogchains](https://tomcritchlow.com/2019/07/17/blogchains/)_.
...
posts that are linked together.

## Goodbye _megapost_

As a digital gardener over the last year or so I've definitely seen
where this can be valuable. I've definitely found that "megaposts" can
...
> a rate comparable to their internal evolution rate. There is no lactic acid build-up.
>
