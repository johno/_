...
With [Components AI](https://components.ai), we want to let you explore _all_ of
...
It's important to make randomly generated values feel less drastic and instead more
gradual. We want randomness to be on a slider. We also want to apply common design
knowledge to constrain outputs when desired.
...
Thanks to Adam Morse, Chris Biscardi, Cole Bemis, Taylor Bell, Florian Kissling,
Prince Wilson, Rose Wiegley, Nick Bender, and my wife for reading drafts of this
