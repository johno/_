...
Being able to build software products is an extremely powerful thing.
Every day you probably also see numerous inefficiencies you want to
address with this new power. Unfortunately, time is pretty limited so
you can't address everything.

So, when I'm starting out a new side project I always make sure that
