...
__NOTE__: I'm working on a new project called DesignQL that seeks to standardize the tooling and data structures present in design systems.
...
<div style={{ padding: '1rem', backgroundColor: 'tomato', fontFamily: 'system-ui' }}>
  Seamlessly interleaving components with your content allow you to express yourself more creatively.
</div>
