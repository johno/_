...
export default props => <Container mt={[3, 4, 5]} maxWidth="measureWide" {...props} />
...
My primary emphasis is the front end, where I write performant, reusable CSS/Javascript and design interfaces that are easy, and a delight, to use. I'm passionate about automation, and invest time in automating tasks by building and leveraging tooling.
...
#### Gatsby, Software Engineer - Remote
